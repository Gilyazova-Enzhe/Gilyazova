...
public class Task4 {
    public static void main(String[] args) {
        ...
        String line = sc.nextLine(); //считывается с конс строка

        System.out.println(isRightLine(line, 0, 0)); 
    }

    static boolean isRightLine(String line, int count, int i) { //i номер символа типо счетчика которые пробегает от начала до конца строки 
